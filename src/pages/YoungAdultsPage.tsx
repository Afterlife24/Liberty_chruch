            ...
            <div className="max-w-4xl mx-auto px-6 py-12 md:py-16">
                <div className="text-center">
                    <p className="text-gray-700 text-xl leading-relaxed mb-8">
                        A vibrant community for young adults in their twenties and thirties, navigating life,
                        career, relationships, and faith together in an encouraging environment.
                    </p>
                    <p className="text-gray-700 text-lg leading-relaxed">
                        More information about our Young Adults ministry coming soon. Contact us to learn more
                        about connecting with others in your age group!
                    </p>
                </div>
                ...
                <div className="mt-16 bg-gray-900 text-white p-8 rounded-lg text-center">
                    ...
                    <p className="text-gray-200 text-lg mb-6">
                        Connect with other young adults and find your place in our community.
                    </p>
